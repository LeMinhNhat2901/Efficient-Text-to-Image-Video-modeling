...
def default_video(scene: str, quality_dir: str) -> Path:
    scene_map = {
        ...
        "v02_s00": ("s00_text_pixels_opening", "V02TextPixelsOpening"),
        "v02_s01": ("s01_generative_backbones", "V02GenerativeBackbones"),
        "v02_s02": ("s02_clip_coembedding", "V02ClipCoEmbedding"),
        "v02_s03": ("s03_vqgan_visual_words", "V02VqganVisualWords"),
        "v02_s04": ("s04_architecture_evolution", "V02ArchitectureEvolution"),
        "v02_s05": ("s05_muse_markovgen", "V02MuseMarkovgen"),
        "v02_s06": ("s06_diffusion_intuition", "V02DiffusionIntuition"),
        "v02_s07": ("s07_diffusion_math", "V02DiffusionMath"),
        "v02_s08": ("s08_guidance", "V02Guidance"),
        "v02_s09": ("s09_latent_diffusion_crf", "V02LatentDiffusionCRF"),
        "v02_s10": ("s10_sana_var", "V02SanaVar"),
        "v02_s11": ("s11_discussion_finale", "V02DiscussionFinale"),
    }
...
def default_audio(scene: str) -> Path:
    audio_map = {
        "s00": ROOT / "tts" / "outputs" / "video_01" / "s00_roadmap.wav",
        "s01": ROOT / "tts" / "outputs" / "video_01" / "s01_forward_ou_wiener.wav",
        "s02": ROOT / "tts" / "outputs" / "video_01" / "s02_markov.wav",
        "s03": ROOT / "tts" / "outputs" / "video_01" / "s03_reverse_chain.wav",
        "s04": ROOT / "tts" / "outputs" / "video_01" / "s04_score_compass.wav",
        "s05": ROOT / "tts" / "outputs" / "video_01" / "s05_local_linear.wav",
        "s06": ROOT / "tts" / "outputs" / "video_01" / "s06_mse_conditional_mean.wav",
        "s07": ROOT / "tts" / "outputs" / "video_01" / "s07_training_loop.wav",
        "s08": ROOT / "tts" / "outputs" / "video_01" / "s08_sde_drift_diffusion.wav",
        "s09": ROOT / "tts" / "outputs" / "video_01" / "s09_probability_flow_ode.wav",
        "s10": ROOT / "tts" / "outputs" / "video_01" / "s10_fokker_planck_score.wav",
        "s11": ROOT / "tts" / "outputs" / "video_01" / "s11_reverse_distribution.wav",
        "s12": ROOT / "tts" / "outputs" / "video_01" / "s12_runge_kutta_solver.wav",
        "s13": ROOT / "tts" / "outputs" / "video_01" / "s13_finale_failure.wav",
        "v02_s00": ROOT / "tts" / "outputs" / "video_02" / "s00_text_pixels_opening.wav",
        "v02_s01": ROOT / "tts" / "outputs" / "video_02" / "s01_generative_backbones.wav",
        "v02_s02": ROOT / "tts" / "outputs" / "video_02" / "s02_clip_coembedding.wav",
        "v02_s03": ROOT / "tts" / "outputs" / "video_02" / "s03_vqgan_visual_words.wav",
        "v02_s04": ROOT / "tts" / "outputs" / "video_02" / "s04_architecture_evolution.wav",
        "v02_s05": ROOT / "tts" / "outputs" / "video_02" / "s05_muse_markovgen.wav",
        "v02_s06": ROOT / "tts" / "outputs" / "video_02" / "s06_diffusion_intuition.wav",
        "v02_s07": ROOT / "tts" / "outputs" / "video_02" / "s07_diffusion_math.wav",
        "v02_s08": ROOT / "tts" / "outputs" / "video_02" / "s08_guidance.wav",
        "v02_s09": ROOT / "tts" / "outputs" / "video_02" / "s09_latent_diffusion_crf.wav",
        "v02_s10": ROOT / "tts" / "outputs" / "video_02" / "s10_sana_var.wav",
        "v02_s11": ROOT / "tts" / "outputs" / "video_02" / "s11_discussion_finale.wav",
    }
