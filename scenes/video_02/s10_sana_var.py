...
class V02SanaVar(TextPixelsScene):
    ...
    def sana_pipeline(self):
        ...
        out = self.image_box("external_57_63/cyberpunk_cat.png", 1.7, 1.7, SANA_NEON).move_to([5.35, -1.35, 0])
        ...
        self.play(GrowArrow(arrows[3]), FadeIn(out), FadeIn(out_lbl), run_time=1.0)
        self.wait(25.0)
        self.fast_clear()
    ...
    def var_next_scale(self):
        ...
        self.play(FadeIn(title), FadeIn(current), FadeIn(label), FadeIn(ladder), run_time=1.0)
